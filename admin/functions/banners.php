...
Upload a Banner to use in the banners page: <input name="uploadedfile" type="file" /> 
...
if(isset($_FILES["uploadedfile"])){
  ...
  $target_path = "../../site/customer_images/banners/";
  ...
  if(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) {
    echo "<span style='color:red;'>The file ".  basename( $_FILES['uploadedfile']['name']). 
    " has been uploaded</span>";
  } else{
    echo "<span style='color:red;'>There was an error uploading the file, please try again!</span>";
  }
