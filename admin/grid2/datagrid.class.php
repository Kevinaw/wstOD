...
// Not documented:
// -----------------------------------------------------------------------------
// Property : first_field_focus_allowed
//  --//--  : floating_tool_tips_allowed
//  --//--  : hide_grid_before_serach
//
// Method   : executeSql() 
...
class DataGrid
{
    ...
    function DataGrid($debug_mode = false, $messaging = true, $unique_prefix = "", $datagrid_dir = "datagrid/"){        
        ...
        $this->floating_tool_tips_allowed = false;
    ...
    function writeCssClass($class = "default", $type = "embedded"){        
        ...
        if($this->css_type == "file"){
            ...
            $this->rowColor[5] = "#ece8e4"; // on mouse click
            ...
            if(strtolower($this->css_class) == "green"){
                $this->class_pre            = "pre { padding: 0px; margin: 0px; }";
                $this->class_caption        = ".".$this->unique_prefix."caption {font-size: 16px; font-family: Arial, Helvetica, sans-serif;  font-weight: bold; text-align:center; Padding-bottom: 0;}";
                $this->class_fieldset       = ".class_fieldset { margin: 0px; }";
                $this->class_filter_table   = ".class_filter_table { font-size: 13px;font-family: Arial, Helvetica, sans-serif;align: center; width: 90%; border-collapse: collapse; border: 0px solid #3f7c5f; font: normal 80%/140% arial, verdana, helvetica, sans-serif; color: #000; background: #fff;}";            
                $this->class_paging_table   = ".class_paging_table { font-size: 13px;font-family: Arial, Helvetica, sans-serif;align: center; width: 90%; border-collapse: collapse; border: 0px solid #3f7c5f; font: normal 80%/140% arial, verdana, helvetica, sans-serif; color: #000; background: #fff;}";
                ...
                $this->class_td_main        = ".class_td_main { border: 1px solid #e0e0e0; font-size: 13px; padding: 0.15em; PADDING-LEFT: 6px;PADDING-RIGHT: 6px;}";
                $this->class_td_selected    = ".class_td_selected { BACKGROUND-COLOR: #e4f5ef; border: 1px solid #e0e0e0; font-size: 13px; padding: 0.15em;PADDING-LEFT: 6px;PADDING-RIGHT: 6px;}";                
                $this->class_td             = ".class_td { border: 1px solid #e0e0e0; font-size: 13px; padding: 0.15em;PADDING-LEFT: 6px;PADDING-RIGHT: 6px;}";
                $this->class_resizable_textarea = ".resizable-textarea .grippie { BORDER-RIGHT: #ddd 1px solid; BORDER-TOP: #ddd 0px solid; BACKGROUND: url(".$this->directory."images/common/grippie.png) #ddd no-repeat center 2px; OVERFLOW: hidden; BORDER-LEFT: #ddd 1px solid; CURSOR: s-resize; BORDER-BOTTOM: #ddd 1px solid; height:6px; }";
                $this->class_radiobutton    = ".class_radiobutton {}";
                $this->class_a   = "a.".$this->unique_prefix."class_a { background: transparent; font-size:13px; color: #3f7c5f; text-decoration: none; font-weight: bold;}";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:link { background: transparent; font-size:13px; color: #3f7c5f; text-decoration: none; font-weight: bold;}";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:hover { background: transparent; font-size:13px; color: #6fac8f; text-decoration: none; font-weight: bold;}";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:visited { }";                 
                $this->class_a2  = "a.".$this->unique_prefix."class_a2 { background: transparent; font-size:13px; color: #3f7c5f; text-decoration: none; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:link { background: transparent; font-size:13px; color: #3f7c5f; text-decoration: none; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:hover { background: transparent; font-size:13px; color: #6fac8f; text-decoration: none; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:visited { }";                                 
                ...
                $this->class_caption        = ".".$this->unique_prefix."caption {font-size: 16px; font-family: Arial, Helvetica, sans-serif;  font-weight: bold; text-align:center; Padding-bottom: 0;}";
                $this->class_fieldset       = ".class_fieldset { margin: 0px; }";
                $this->class_filter_table   = ".class_filter_table { font-family: Arial, Helvetica, sans-serif;border:0px solid #000000;font-size: 13px;border-collapse:collapse;margin:0;padding:0;}";            
                $this->class_paging_table   = ".class_paging_table { font-family: Arial, Helvetica, sans-serif;border:0px solid #000000;font-size: 13px;border-collapse:collapse;margin:0;padding:0;}";
                $this->class_table          = ".class_table { font-family: Arial, Helvetica, sans-serif;border:1px solid #000000;font-size: 13px;border-collapse:collapse;margin:0;padding:0;}";
                ...
                $this->class_td_main        = ".class_td_main { line-height: 18px;font-weight: bold;color: #000000;text-indent: 7px;text-align: center;vertical-align:center;border:1px solid #e0e0e0;PADDING-LEFT: 6px;PADDING-RIGHT: 6px;}";
                $this->class_td_selected    = ".class_td_selected { BACKGROUND-COLOR: #f0f0f0; vertical-align:center;line-height: 18px;text-indent: 7px;text-align: center;border:1px solid #e0e0e0;PADDING-LEFT: 6px;PADDING-RIGHT: 6px;}";
                $this->class_td             = ".class_td { vertical-align:center;line-height: 18px;text-indent: 7px;text-align: center;border:1px solid #e0e0e0;PADDING-LEFT: 6px;PADDING-RIGHT: 6px;}";            
                $this->class_resizable_textarea = ".resizable-textarea .grippie { BORDER-RIGHT: #ddd 1px solid; BORDER-TOP: #ddd 0px solid; BACKGROUND: url(".$this->directory."images/common/grippie.png) #ddd no-repeat center 2px; OVERFLOW: hidden; BORDER-LEFT: #ddd 1px solid; CURSOR: s-resize; BORDER-BOTTOM: #ddd 1px solid; height:6px; }";
                $this->class_radiobutton    = ".class_radiobutton {}";
                $this->class_a   = "a.".$this->unique_prefix."class_a { background: transparent; font-size:13px; color: #225588; text-decoration: none; }";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:link { background: transparent; font-size:13px; color: #225588; text-decoration: none; }";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:hover { background: transparent; font-size:13px; color: #6699bb; text-decoration: none; }";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:visited { }";                 
                $this->class_a2  = "a.".$this->unique_prefix."class_a2 { background: transparent; font-size:13px; color: #000075; text-decoration: none; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:link { background: transparent; font-size:13px; color: #000075; text-decoration: none; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:hover { background: transparent; font-size:13px; color: #aaaaaa; text-decoration: none; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:visited { }";                                 
                ...
                $this->class_pre            = "pre { padding: 0px; margin: 0px; }";
                $this->class_caption        = ".".$this->unique_prefix."caption { FONT: NORMAL 14px Tahoma; font-weight: bold; text-align:center; Padding-bottom: 0;}";                
                $this->class_fieldset       = ".class_fieldset { margin: 0px;BORDER: #BFCDE1 1px solid;}";
                ...
                $this->class_td_main        = ".class_td_main { BORDER-RIGHT: #d0d7e5 1px solid; PADDING-RIGHT: 6px; PADDING-LEFT: 6px; PADDING-BOTTOM: 2px; FONT: Tahoma; BORDER-LEFT: #ffffff 1px solid; PADDING-TOP: 2px; BORDER-BOTTOM: #d0d7e5 1px solid; }";
                $this->class_td             = ".class_td { BORDER-RIGHT: #d0d7e5 1px solid; PADDING-RIGHT: 6px; PADDING-LEFT: 6px; PADDING-BOTTOM: 1px; PADDING-TOP: 1px; FONT: Tahoma; BORDER-LEFT: #ffffff 1px solid; BORDER-BOTTOM: #d0d7e5 1px solid; }";
                $this->class_td_selected    = ".class_td_selected { BORDER-RIGHT: #d0d7e5 1px solid; PADDING-RIGHT: 6px; PADDING-LEFT: 5px; PADDING-BOTTOM: 2px; FONT: Tahoma; BORDER-LEFT: #ffffff 1px solid; PADDING-TOP: 2px; BORDER-BOTTOM: #d0d7e5 1px solid; }";
                ...
                $this->class_ok_message     = ".class_ok_message { FONT: NORMAL 12px Tahoma; COLOR: #00ab00; }";                
                $this->class_a   = "a.".$this->unique_prefix."class_a { background: transparent; color: #225588; text-decoration: none; FONT-SIZE: 12px; FONT-FAMILY: Tahoma; }";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:link { background: transparent; color: #225588; text-decoration: none; FONT-SIZE: 12px; FONT-FAMILY: Tahoma; }";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:hover { background: transparent; color: #6699bb; text-decoration: none; FONT-SIZE: 12px; FONT-FAMILY: Tahoma; }";
                $this->class_a  .= "a.".$this->unique_prefix."class_a:visited { }";                 
                $this->class_a2  = "a.".$this->unique_prefix."class_a2 { background: transparent; color: #225588; text-decoration: none; FONT-SIZE: 12px; FONT-FAMILY: Tahoma; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:link { background: transparent; color: #225588; text-decoration: none; FONT-SIZE: 12px; FONT-FAMILY: Tahoma; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:hover { background: transparent; color: #6699bb; text-decoration: none; FONT-SIZE: 12px; FONT-FAMILY: Tahoma; }";
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:visited { background: transparent; color: #225588; text-decoration: none; FONT-SIZE: 12px; FONT-FAMILY: Tahoma; }";
                ...
                $this->css_class            = "default";
                $this->css_font_family      = "FONT-FAMILY: Tahoma;";
                $this->class_pre            = "pre { padding: 0px; margin: 0px; }";
                $this->class_caption        = ".".$this->unique_prefix."caption { FONT: NORMAL 14px Tahoma; font-weight: bold; text-align:center; Padding-bottom: 0;}";
                $this->class_fieldset       = ".class_fieldset { margin: 0px; BORDER: #dddddd 1px solid;}";
                ...
                $this->class_th_normal      = ".class_th_normal { BORDER-BOTTOM: #d2d0bb 2px solid; BORDER-RIGHT: #d2d0bb 2px solid; BORDER-LEFT: #e1e2e3 2px solid; MARGIN-LEFT: 0px; PADDING-RIGHT: 2px; PADDING-LEFT: 5px; PADDING-BOTTOM: 2px; FONT: bold 13px Tahoma; COLOR: #333333; PADDING-TOP: 2px; BACKGROUND-COLOR: #e2e0cb}";                
                ...
                $this->class_td_main        = ".class_td_main { BORDER-TOP: #f1efe2 1px solid; BORDER-RIGHT: #fefefe 1px solid; BORDER-LEFT: #e1e2e3 1px solid; PADDING-RIGHT: 6px; PADDING-LEFT: 6px; PADDING-BOTTOM: 2px; PADDING-TOP: 2px; FONT: normal 12px Tahoma; }";
                $this->class_td             = ".class_td { BORDER: #f0eee1 1px solid; PADDING-RIGHT: 6px; PADDING-LEFT: 6px; PADDING-BOTTOM: 2px; PADDING-TOP: 2px; FONT: normal 12px Tahoma;  }";
                $this->class_td_selected    = ".class_td_selected { BORDER: #f1efe2 1px solid; PADDING-RIGHT: 6px; PADDING-LEFT: 6px; PADDING-BOTTOM: 2px; FONT: normal 12px Tahoma; PADDING-TOP: 2px; }";
                ...
                $this->class_resizable_textarea = ".resizable-textarea .grippie { BORDER-RIGHT: #d2d0bb 1px solid; BORDER-TOP: #d2d0bb 1px solid; BACKGROUND: url(".$this->directory."images/common/grippie.png) #eee no-repeat center 2px; OVERFLOW: hidden; BORDER-LEFT: #d2d0bb 1px solid; CURSOR: s-resize; BORDER-BOTTOM: #d2d0bb 1px solid; height:6px; }";
                $this->class_checkbox       = ".class_checkbox { BORDER: 0px; FONT: NORMAL 12px Tahoma;width:20px;}";
                $this->class_radiobutton    = ".class_radiobutton { BORDER: 0px; FONT: NORMAL 12px Tahoma;width:20px;}";
                ...
                $this->class_a   = "a.".$this->unique_prefix."class_a { background: transparent; color: #72705b; text-decoration: none; FONT-SIZE: 12px; ".$this->css_font_family."}"; 
                $this->class_a  .= "a.".$this->unique_prefix."class_a:link { background: transparent; color: #72705b; text-decoration: none; FONT-SIZE: 12px; ".$this->css_font_family."}"; 
                $this->class_a  .= "a.".$this->unique_prefix."class_a:hover { background: transparent; color: #f0c030; text-decoration: none; FONT-SIZE: 12px; ".$this->css_font_family."}";   
                $this->class_a  .= "a.".$this->unique_prefix."class_a:visited { }";                 
                $this->class_a2  = "a.".$this->unique_prefix."class_a2 { background: transparent; color: #72705b; text-decoration: none; FONT-SIZE: 12px; ".$this->css_font_family."}"; 
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:link { background: transparent; color: #72705b; text-decoration: none; FONT-SIZE: 12px; ".$this->css_font_family."}"; 
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:hover { background: transparent; color: #ffcc33; text-decoration: none; FONT-SIZE: 12px; ".$this->css_font_family."}"; 
                $this->class_a2 .= "a.".$this->unique_prefix."class_a2:visited { background: transparent; color: #72705b; text-decoration: none; FONT-SIZE: 12px; ".$this->css_font_family."}"; 
                $this->rowColor[0] = "#fcfaf6";  
                $this->rowColor[1] = "#ffffff";            
                $this->rowColor[2] = "#ebeadb"; // dark
                $this->rowColor[3] = "#ebeadb"; // light
        ...
        if($req_print == true){
            $this->class_pre            = "pre { padding: 0px; margin: 0px; }";
            $this->class_table          = ".class_table {BORDER: #d0d0d0 1px solid; FONT: NORMAL 12px Tahoma;}";            
        ...
        // common classes
        $this->class_left           = ".class_left { TEXT-ALIGN: left; }";
        $this->class_center         = ".class_center { TEXT-ALIGN: center; }";
        $this->class_right          = ".class_right { TEXT-ALIGN: right; }";
        ...
        if($this->css_type == "file"){
            ...
            echo "<![endif]-->\n";
            echo "<style type='text/css'>\n";
            echo ".class_nowrap { white-space: nowrap; }";
            echo $this->class_pre."\n";
            ...
            echo $this->class_left."\n";
            echo $this->class_center."\n";
            echo $this->class_right."\n";
            echo $this->class_resizable_textarea."\n";
            echo "</style>\n";
        }    
    }
    ...
    function dataSource($db_handl, $sql = "", $start_order = "", $start_order_type = ""){        
        ...
        // handle SELECT statments with sub-SELECTs and SELECT without WHERE
        if($this->lastSubStrOccurence($this->sql_view, "from ") < $this->lastSubStrOccurence($this->sql_view, "where ")){
            $this->sql_view .= " WHERE 1=1 ";
        }else if(($this->lastSubStrOccurence($this->sql_view, "where ") == "") && ($this->lastSubStrOccurence($this->sql_view, "having ") == "") ){
            $this->sql_view .= " WHERE 1=1 ";
        }
    ...
    function getDataSet($fsort = "", $limit = ""){
        ...
        if($this->debug){
            echo "<table width='".$this->tblWidth[$this->mode]."'><tr><td align='left' class='class_error_message no_print' style='color: #333333;'><b>search sql (".strtolower($this->lang['total']).": ".$this->rows.") </b>". $this->sql.$fsort." ".$limit."</td></tr></table><br />";
        }
        ...
        if((($req_mode == "edit") || ($req_mode == "details")) && ($req_rid != "")){          
            ...
            if(($this->layouts['view'] == 0) && ($this->layouts['edit'] == 1) && ($req_mode == "details")){
                ...
                if(count($this->rids) > 1){ 
                    ...
                    foreach ($this->rids as $key){ $where .= ", '".$key."' "; }
                    $where .= ") ";
    ...
    function allowExporting($option = true) { $this->exporting_allowed = (($option == true) || ($option == "true")) ? true : false ; }    
    function allowSorting($option = true)   { $this->sorting_allowed = (($option == true) || ($option == "true")) ? true : false ; }    
    function allowFiltering($option = false){ $this->filtering_allowed = (($option == true) || ($option == "true")) ? true : false ; }
    ...
    function showCaption() {
        echo ($this->caption != "") ? "<div class='".$this->unique_prefix."caption'>". $this->caption ."</div>" : "";
    }
    ...
    function colOpen($align='left', $colSpan=0, $wrap='', $bgcolor='', $class_td='class_td', $width=''){
        $req_print = $this->getVariable('print');
        $wrap = ($wrap == '') ? $this->wrap : $wrap;
        $class_align = ($align == "") ? "" : " class_".$align;
    ...
    function drawControlPanel(){       
        ...
        if($this->exporting_allowed){
            echo "<td align='right' width='20px'>";
                if((($req_export == "") || ($req_print != true)) && ($req_print == "")){
                    echo "<a style='cursor:pointer;' onClick=\"myRef=window.open(''+self.location+'".(($_SERVER['QUERY_STRING'] == "")?"?":"&").$this->unique_prefix."export=true&".$this->unique_prefix."export_type=csv','ExportToExcel','left=100,top=100,width=540,height=360,toolbar=0,resizable=0,location=0,scrollbars=1');myRef.focus();\" class='".$this->unique_prefix."class_a'>";
                    ...
                    echo "</td>";
                    echo "<td align='right' width='20px'>";
                    echo "<a style='cursor:pointer;' onClick=\"myRef=window.open(''+self.location+'".(($_SERVER['QUERY_STRING'] == "")?"?":"&").$this->unique_prefix."export=true&".$this->unique_prefix."export_type=xml','ExportToExcel','left=100,top=100,width=540,height=360,toolbar=0,resizable=0,location=0,scrollbars=1');myRef.focus();\" class='".$this->unique_prefix."class_a'>";
        ...
        if($this->printing_allowed){
            if(($req_export == "") && ($req_print != true)){
                echo "<td align='right' width='20px'>";
                echo "<a style='cursor:pointer;' onClick=\"myRef=window.open(''+self.location+'".(($_SERVER['QUERY_STRING'] == "")?"?":"&").$this->unique_prefix."print=true','PrintableView','left=20,top=20,width=840,height=630,toolbar=0,menubar=0,resizable=0,location=0,scrollbars=1');myRef.focus()\" class='".$this->unique_prefix."class_a'><img src='".$this->directory."images/".$this->css_class."/print_b.gif' onmouseover='this.src=\"".$this->directory."images/".$this->css_class."/print_r.gif\"' onmouseout='this.src=\"".$this->directory."images/".$this->css_class."/print_b.gif\"' alt='".$this->lang['printable_view']."' title='".$this->lang['printable_view']."' /></a>";
            }else{
                echo "<td align='right'>";                    
                echo "<a style='cursor:pointer; ' onClick='window:print();' class='".$this->unique_prefix."class_a no_print'  title='".$this->lang['print_now_title']."'>".$this->lang['print_now']."</a>";
            }
        }
        echo "</td>";        
        echo "</tr>";
    ...
    function exportToCsv(){
        ...
        $fe = fopen($this->directory."export.csv", "w+");
        if($fe){            
            $somecontent = "";       
            // fields headers
            ...
            echo "<label class='class_error_message no_print'>".$this->lang['file_opening_error']."</lable>";
            exit;
        }
    ...
    function exportToXml(){
        // Let's make sure the we create the file first
        $this->req_page_size = (isset($_REQUEST[$this->unique_prefix.'page_size']))?$_REQUEST[$this->unique_prefix.'page_size']:$this->req_page_size;
        $fe = fopen($this->directory."export.xml", "w+");        
        if($fe){
    ...
    function drawFiltering(){
        ...
        if($this->filtering_allowed){
            ...
            if($req_print != true){
                echo "<fieldset class='class_fieldset' dir='".$this->direction."' align='".$this->tblAlign[$this->mode]."' style='width: ".$this->tblWidth['view']."'>\n";
                    ...
                    switch($filter_field_type){
                        ...
                        case "dropdownlist":
                            ...
                            if(is_array($fldValue['source'])){
                                foreach($fldValue['source'] as $opt => $val){
                                    echo "<option value='".$val."' ";
                                    if($filter_field_value == $val) echo "selected";
                                    echo ">".$opt."</option>";
                                }                
                            }else{                                
                                $sql = "SELECT DISTINCT ".$fldValue['field']." FROM ".$fldValue['table']." ORDER BY ".$fldValue['field']." ".((strtolower((isset($fldValue['order']) ? $fldValue['order'] : "")) == "desc")?"DESC":"ASC")." ;";
            ...
            if($req_print != true){
                if($req_onSUBMIT_FILTER != ""){
                    echo "<input class='class_button' type='button' value='".$this->lang['reset']."' onClick='document.location.href=\"".$this->HTTP_URL."\"'>&nbsp;";
                }
    ...
    function drawTabular(){
        ...
        echo "<div id='".$this->unique_prefix."loading_image'><br /><table align='center'><tr><td valign='middle'>".$this->lang['loading_data']."</td><td valign='middle'><img src='".$this->directory."images/common/loading.gif' /></table></div>";                
        ...
        $this->rowOpen("");
            ...
            if(($this->multirow_allowed) && ($this->rows_total > 0)){                
                $this->colOpen("center",0,"nowrap",$this->rowColor[0],"class_td", "26px");
                echo $this->nbsp;
                $this->colClose();
            }            
            ...
            if(isset($this->modes['add'][$this->mode]) && $this->modes['add'][$this->mode]){            
                ...
                if(isset($this->modes['edit'][$this->mode]) && $this->modes['edit'][$this->mode]){
                    $this->mainColOpen("center",0,"nowrap", "1%", "class_th_normal"); echo $this->nbsp; $this->mainColClose();                
                }
            }
            ...
            if(($this->rid == -1) && ($req_mode == "add")){
                foreach($this->columns_edit_mode as $key => $val){
                    if($this->columns_edit_mode[$key]['type'] != "hidden"){
                ...
                if($this->mode === "view"){                
                    ...
                    for($c_sorted = $this->col_lower; $c_sorted < count($this->sorted_columns); $c_sorted++){
                        ...
                        $field_name = $this->getFieldName($c);
                        if($this->canViewField($field_name)){
                            $wrap = isset($this->columns_view_mode[$field_name]['wrap']) ? $this->columns_view_mode[$field_name]['wrap'] : $this->wrap;
                            $width = isset($this->columns_view_mode[$field_name]['width']) ? $this->columns_view_mode[$field_name]['width'] : "";
                            if($this->sorting_allowed && ($req_print != true) && $req_sort_field && ($c == ($req_sort_field -1))){ $th_css_class = "class_th_selected"; } else { $th_css_class = "class_th" ;};                
                            ...
                            if($this->sorting_allowed){
                                ...
                                if($req_print != true){
                                    $href_string .= $this->amp.$this->unique_prefix."sort_field=".($c+1).$this->amp.$this->unique_prefix."sort_type=";
            ...
            if(isset($this->modes['details'][$this->mode]) && $this->modes['details'][$this->mode]){
                $this->mainColOpen("center",0,"nowrap", "10%", "class_th_normal");echo $this->lang['view'];$this->mainColClose();
            }                        
            if(isset($this->modes['delete'][$this->mode]) && $this->modes['delete'][$this->mode]){
                $this->mainColOpen("center",0,"nowrap", "10%", "class_th_normal");echo $this->lang['delete'];$this->mainColClose();
            }                
        $this->rowClose();
        // *** END HEADERS -----------------------------------------------------
        ...
        for($r = $this->row_lower; (($r >=0 && $this->row_upper >=0) && ($r < $this->row_upper) && ($r < ($this->row_lower + $this->req_page_size))); $r++){            
            ...
            if(($r == $this->row_lower) && ($this->rid == -1) && ($req_mode == "add")){
                ...
                echo "<form name='".$this->unique_prefix."frmEditRow' method='post' action='".$curr_url."'>";
                $this->setEditFieldsFormScript($curr_url);
                // draw multi-row empty cell
                if(($this->multirow_allowed) && (!$this->is_error)){$this->colOpen("center",0,"nowrap",$this->rowColor[0],"class_td");echo $this->nbsp;$this->colClose();}                            
                ...
                foreach($this->columns_edit_mode as $key => $val){
                    if($this->columns_edit_mode[$key]['type'] != "hidden"){
                        ...
                        if($this->isForeignKey($key)){
                            echo $this->nbsp; $this->drawForeignKeyInput(-1, $key, '-1', "edit"); echo $this->nbsp;
                        }else{
            ...
            if($quick_exit == true){
                $this->tblClose();
                echo "<script>document.getElementById('".$this->unique_prefix."loading_image').style.display='none';</script>";                
            ...
            if(isset($this->modes['edit'][$this->mode]) && $this->modes['edit'][$this->mode]){
                    ...
                    if(isset($this->modes['edit'][$this->mode]) && $this->modes['edit'][$this->mode]){
                        ...
                        if (isset($this->modes['edit']['byFieldValue']) && ($this->modes['edit']['byFieldValue'] != "")){
                            if($this->getFieldOffset($this->modes['edit']['byFieldValue']) == "-1"){
                                ...
                                $this->colOpen(($this->direction == "rtl")?"right":"left",0,"nowrap",$main_td_color,"class_td_main");
                                echo $this->nbsp."<a class='".$this->unique_prefix."class_a' href='$curr_url'>".$row[$this->getFieldOffset($this->modes['edit']['byFieldValue'])]."</a>".$this->nbsp;
                            }                            
                        }else{
                            $this->colOpen("center",0,"nowrap",$main_td_color,"class_td_main");                            
                            $this->drawModeButton("edit", $curr_url, $this->lang['edit'], $this->lang['edit_record'], "edit.gif", "\"javascript:document.location.href='".$this->HTTP_URL.$curr_url."'\"", false, $this->nbsp, "");
                ...
                if(isset($this->modes['add'][$this->mode]) && $this->modes['add'][$this->mode]){                    
                    $this->colOpen("center",0,"nowrap",$this->rowColor[2],"class_td_main");$this->colClose();                    
                }
            }
            ...
            for($c_sorted = $this->col_lower; $c_sorted < count($this->sorted_columns); $c_sorted++){
                ...
                if(($this->mode === "view") && ($this->canViewField($this->getFieldName($c)))){                    
                    if($req_sort_field == $c+1){
                        $this->colOpen($col_align,0,$wrap, $this->rowColor[0], 'class_td_selected'); 
                    }else{
                    ...
                    if($this->columns_edit_mode[$this->getFieldName($c)]['type'] == "hidden"){
                        ...
                        if(intval($this->rid) === intval($row[$this->getFieldOffset($this->primary_key)])){
                            $this->colOpen("left",0,$wrap);
                            if($this->isForeignKey($this->getFieldName($c))){
                                echo $this->nbsp; $this->drawForeignKeyInput($row[$this->getFieldOffset($this->primary_key)], $this->getFieldName($c), $row[$c], "edit"); echo $this->nbsp;
                            }else{
                            ...
                            $this->colOpen($col_align,0,$wrap);
                            if($this->isForeignKey($this->getFieldName($c))){
                                echo $this->nbsp;$this->drawForeignKeyInput($row[$this->getFieldOffset($this->primary_key)], $this->getFieldName($c), $row[$c],"view");echo $this->nbsp;
                            }else{
    ...
    function drawColumnar(){      
        ...
        echo "<div id='".$this->unique_prefix."loading_image'><br /><table align='center'><tr><td valign='middle'>".$this->lang['loading_data']."</td><td valign='middle'><img src='".$this->directory."images/common/loading.gif' /></td></tr></table></div>";                
        echo "<form name='".$this->unique_prefix."frmEditRow' method='post' action='".$curr_url."'>";        
        $this->tblOpen();
        // draw header
        $this->rowOpen($r);        
        $this->mainColOpen("center",0,"nowrap","32%", (($req_print == true) ? "class_td" : "class_th")); echo "<b>".$this->lang['field']."</b>"; $this->mainColClose();
        $this->mainColOpen("center",0,"nowrap","68%", (($req_print == true) ? "class_td" : "class_th")); echo "<b>".$this->lang['field_value']."</b>"; $this->mainColClose();
        $this->rowClose();        
        ...
        if($this->rid == -1){            
            foreach($this->columns_edit_mode as $key => $val){
                ...
                if($key == "delimiter"){
                    ...
                    if(isset($this->columns_edit_mode["delimiter"]['inner_html'])){ echo $this->columns_edit_mode["delimiter"]['inner_html']; }                    
                    $this->colClose();
                }else if($this->columns_edit_mode[$key]['type'] == "hidden"){
                    echo $this->getFieldValueByType('', 0, '', $key);
                }else{
                    // column's header
                    ...
                    if($this->isForeignKey($key)){
                        echo $this->nbsp; echo $this->drawForeignKeyInput(-1, $key, '-1', "edit"); echo $this->nbsp;
                    }else{
                        echo $this->getFieldValueByType('', 0, '', $key);
                    }
                    $this->colClose();
        ...
        for($r = $this->row_lower; (($this->rid != -1) && ($r < $this->row_upper) && ($r < ($this->row_lower + $this->req_page_size))); $r++){                               
            ...
            for($c_sorted = $this->col_lower; $c_sorted < count($this->sorted_columns); $c_sorted++){
                ...
                if($this->canViewField($this->getFieldName($c))){
                    if(isset($this->columns_edit_mode[$this->getFieldName($c)]['type']) && ($this->columns_edit_mode[$this->getFieldName($c)]['type'] == "hidden")){
                        echo $this->getFieldValueByType('', 0, '', $this->getFieldName($c));                        
                    }else{
                        ...
                        if(($this->mode === "view") && ($this->canViewField($this->getFieldName($c)))){
                            ...
                            $this->colClose();                    
                                ...
                                if($this->isForeignKey($this->getFieldName($c))){
                                    echo $this->drawForeignKeyInput($row[$this->getFieldOffset($this->primary_key)], $this->getFieldName($c), $row[$c],"view");
                                }else{
                                    echo $this->getFieldValueByType($row[$c], $c, $row);
                                }
                                $this->colClose();
                                ...
                                if(intval($rid_value) === intval($row[$ind])){
                                        $this->colOpen($col_align,0,"nowrap");
                                        if($this->isForeignKey($this->getFieldName($c))){
                                            echo $this->nbsp;$this->drawForeignKeyInput($row[$ind], $this->getFieldName($c), $row[$c], "edit");echo $this->nbsp;
                                        }else{
                                            echo $this->getFieldValueByType($row[$c], $c, $row);
                                        }
                                        $this->colClose();
                                    ...
                                    if($this->rid == -1){
                                        // add new row                                    
                                        if($this->isForeignKey($this->getFieldName($c))){
                                            echo $this->nbsp;$this->drawForeignKeyInput(-1, $this->getFieldName($c), '-1', "edit"); echo $this->nbsp;
                                        }else{
        ...
        if(($r == $this->row_lower) && ($this->rid != -1)){
            ...
            echo "<br /><center>";
            if($req_print != ""){
                echo "<span class='".$this->unique_prefix."class_a'><b>".$this->lang['back']."</b></span>";                                        
            }else{
                echo "<a class='".$this->unique_prefix."class_a' href='javascript:history.go(-1);'><b>".$this->lang['back']."</b></a>";                    
            }                
            echo "</center>";        
        }else{            
            $this->tblOpen();
            $this->rowOpen($r, $this->rowColor[1]);
            $this->mainColOpen('left', 0, '', '', (($req_print == true) ? "class_td_normal" : "class_th"), "style='BORDER-RIGHT: #d2d0bb 0px solid;'");
            if($this->mode === "details"){
                ...
                if($req_print != ""){
                    echo ";'><span class='".$this->unique_prefix."class_a'><b>".$this->lang['back']."</b></span></div>";                                        
                }else{
                    echo ";'>";
                ...
                if(($this->rid != -1) && isset($this->modes['delete'][$this->mode]) && $this->modes['delete'][$this->mode]){
                    ...
                    ///d 1.12.2007
                    //$this->mainColClose();
                    //$this->mainColOpen('', '', '', '68%', (($req_print == true) ? "class_td_normal" : "class_th"));
                }
                        ...
                        <td align='left' valign='center' class='class_nowrap'>";
                            ...
                            if($count > 0){
                                echo "<img style='padding:0px; margin:0px;' src='".$this->directory."images/".$this->css_class."/arrow_ltr.png' border='0' width='38' height='22' alt='".$this->lang['with_selected'].":' title='".$this->lang['with_selected'].":' />";
                                    if(!$req_print){
                                        echo "<a class='".$this->unique_prefix."class_a' href='#' onClick='".$this->unique_prefix."setCheckboxes(true); return false;'>".$this->lang['check_all']."</a>
                                        &nbsp;/&nbsp;
                                        <a class='".$this->unique_prefix."class_a' href='#' onClick='".$this->unique_prefix."setCheckboxes(false); return false;'>".$this->lang['uncheck_all']."</a>";
                                    }else{
                                        echo "<a class='".$this->unique_prefix."class_label'>".$this->lang['check_all']."</label>
                                        &nbsp;/&nbsp;
                                        <a class='".$this->unique_prefix."class_label'>".$this->lang['uncheck_all']."</label>";                                    
                                    }
                                echo "    
                                    &nbsp;&nbsp;&nbsp;
        ...
        if(count($this->summarize_columns) > 0){
            ...
            for($c_sorted = $this->col_lower; $c_sorted < count($this->sorted_columns); $c_sorted++){
                ...
                if($c_sorted == $this->col_lower){
                    ...
                    {
                        $this->colOpen("center",0,"nowrap",$this->rowColor[2],"class_td_main");
                        echo "<a class='".$this->unique_prefix."class_a'><b>".$this->lang['total'].":</b></a>";
                        $this->colClose();                    
                    }
                    if($this->rows_numeration){
                ...
                if($this->canViewField($this->getFieldName($c))){    
                    ...
                    if(isset($this->columns_view_mode[$this->getFieldName($c)]['summarize']) && ($this->columns_view_mode[$this->getFieldName($c)]['summarize'] === true))
                        echo $this->nbsp."=".$this->nbsp."<a class='".$this->unique_prefix."class_a'><b>".number_format($this->summarize_columns[$this->getFieldName($c)], 2)."</b></a>";
                    $this->colClose();                
                }
    ...
    function displayWarnings(){
        ...
        if($this->debug){
            ...
            if(count($this->warnings) > 0){
                echo "<font class='class_error_message no_print'><u><b>".$this->lang['warnings']."</b></u>:</font><br />";
            }
            foreach($this->warnings as $key){
                echo "<font class='class_error_message no_print'>".(++$count).") $key</font><br />";            
            }
            echo "<br />";
        }
        echo "</td></tr></table>";                    
    ...
    function displayErrors(){
        ...
        if($this->debug){
            ...
            if(count($this->errors) > 0){
                echo "<font class='class_error_message no_print'><u><b>".$this->lang['errors']."</b></u>:</font><br /><br />";
            }
            foreach($this->errors as $key){
                echo "<font class='class_error_message no_print'>".(++$count).") </font>";
                echo "<font class='class_label'>".substr($key, 0, strpos($key, "["))."</font><br />";
                echo "<font class='class_error_message no_print'>".stristr($key, "[")."</font><br /><br />";                
            }
            echo "<br />";            
        }
        echo "</td></tr></table>";            
    ...
    function displayMessages(){
        if($this->messaging && $this->act_msg){
            ...
            if($this->is_error) $css_class= "class_error_message no_print";
            if($this->is_warning) $css_class= "class_error_message no_print";            
    ...
    function setSqlLimitByDbType($limit_start="", $limit_size=""){
        ...
        switch($this->db_handler->phptype){
            case "oci8":    // oracle                
                ...
                break;          
            case "mssql":   // mssql                
                $limit_string = "TOP ".$req_page_size ." ";
                break;          
    ...
    function setSqlByDbType($sql="", $order_by="", $limit=""){
        ...
        switch($this->db_handler->phptype){
            case "oci8":    // oracle                
                $sql_string = $sql." ".$limit." ".$order_by;                            
                break;          
            case "mssql":   // mssql            
                $sql_string = "SELECT ".$limit." ".substr($sql, strpos("select", strtolower($sql))+7, strlen($sql));                
                break;          
            case "mysql":   // mysql and others
            default:
    ...
    function pagingSecondPart($lu_paging=false, $upper_br, $lower_br, $type="1"){
        ...
        if($this->pages_total >= 1){
            ...
            if($lu_paging['pages']){
                ...
                $text .= "&nbsp;<".$a_tag." title='".$this->lang['first']."' class='".$this->unique_prefix."class_a' style='text-decoration: none;' ".$href_first.">|<&lt;</".$a_tag.">";
                if($this->page_current > 1) $text .= "&nbsp;<".$a_tag." class='".$this->unique_prefix."class_a' style='text-decoration: none;' title='".$this->lang['previous']."' ".$href_prev1.">&lt;&lt;</".$a_tag.">";
                else $text .= "&nbsp;<".$a_tag." class='".$this->unique_prefix."class_a' style='text-decoration: none;' title='".$this->lang['previous']."' ".$href_prev2.">&lt;&lt;</".$a_tag.">";
                $text .= "&nbsp;";
                ...
                for($ind=$start_index; $ind <= $end_index; $ind++){
                    if($ind == $this->page_current) $text .= "&nbsp;<".$a_tag." class='".$this->unique_prefix."class_a' style='text-decoration: underline;' title='".$this->lang['current']."' href='$href_string".$this->amp.$this->unique_prefix."p=".$ind."'><b><u>" . $ind . "</u></b></".$a_tag.">";
                    else $text .= "&nbsp;<".$a_tag." class='".$this->unique_prefix."class_a' style='text-decoration: none;' href='$href_string".$this->amp.$this->unique_prefix."p=".$ind."'>".$ind."</".$a_tag.">";
                ...
                if($this->page_current < $this->pages_total) $text .= "&nbsp;<".$a_tag." class='".$this->unique_prefix."class_a' style='text-decoration: none;' title='".$this->lang['next']."' ".$href_next1.">&gt;&gt;</".$a_tag.">";
                else $text .= "&nbsp;<".$a_tag." class='".$this->unique_prefix."class_a' style='text-decoration: none;' title='".$this->lang['next']."' ".$href_next2.">&gt;&gt;</".$a_tag.">";
                $text .= "&nbsp;<".$a_tag." class='".$this->unique_prefix."class_a' style='text-decoration: none;' title='".$this->lang['last']."' ".$href_last.">&gt;>|</".$a_tag.">";
            }
    ...
    function deleteRow($rid){
        ...
        if($this->debug) echo "<table width='".$this->tblWidth[$this->mode]."'><tr><td align='left'><b>delete sql (".strtolower($this->lang['total']).": ".$affectedRows.") </b>".$sql."</td></tr></table><br />";        
    ...
    function updateRow($rid){
        ...
        foreach($this->columns_edit_mode as $fldName => $fldValue){
            if(($fldName != "") && isset($fldValue['unique']) && ($fldValue['unique'] === true || $fldValue['unique'] === "true")){
                $field_prefix = "syy";                    
        ...
        if(!$unique_field_found){
            $sql = "UPDATE $this->tbl_name SET ";
                ...
                foreach($_POST as $fldName => $fldValue){
                    ...
                    if(!strpos($fldName, "file_act")){
                        ...
                        if(!$this->isReadonly($fldName)){
                            if (intval($ind) > 1) $sql .= ", ";
                            if($this->isText($fldName)){
                                $sql .=  "$fldName = '".mysql_real_escape_string($fldValue)."' ";
                            }else{
            ...
            if($this->debug) echo "<table width='".$this->tblWidth[$this->mode]."'><tr><td align='left'><b>update sql (".strtolower($this->lang['total']).": ".$affectedRows.") </b>".$sql."</td></tr></table><br />";                    
        }else{
            $this->is_warning = true;            
            $this->act_msg = str_replace("_FIELD_", $field_header, $this->lang['unique_field_error']);               
            if($this->debug) echo "<table width='".$this->tblWidth[$this->mode]."'><tr><td align='left'><b>select sql (".strtolower($this->lang['total']).": ".$field_count.") </b>".$sql."</td></tr></table><br />";                    
        }
        if($this->debug) $this->act_msg .= " ".$this->lang['record_n']." ".$this->rid;        
    }
    ...
    function addRow(){
        ...
        if(!$unique_field_found){
            ...
            $sql .= ") VALUES (";
                ...
                foreach($_POST as $fldName => $fldValue){
                    ...
                    if(!strpos($fldName, "file_act")){                 
                        ...
                        if($this->isText($fldName)) {                        
                            if(trim($fldValue) != ""){
                                $sql .=  "'".mysql_real_escape_string($fldValue)."'";
            ...
            $affectedRows = $this->db_handler->affectedRows();
            if($this->debug) echo "<table width='".$this->tblWidth[$this->mode]."'><tr><td align='left'><b>insert sql (".strtolower($this->lang['total']).": ".$affectedRows.") </b>".$sql."</td></tr></table><br />";
    ...
    function isReadonly($field_name){
        if (isset($this->columns_edit_mode[$field_name]['readonly']) && (($this->columns_edit_mode[$field_name]['readonly'] == "true") || ($this->columns_edit_mode[$field_name]['readonly'] == true)))
            return true;
        else
            return false;
    }    
    ...
    function drawForeignKeyInput($keyFieldValue, $fk_field_name, $fk_field_value, $mode="edit"){
        ...
        $disabled = "";
        if($req_mode == "edit"){
            if(isset($this->columns_edit_mode[$fk_field_name]['readonly'])
               && ((($this->columns_edit_mode[$fk_field_name]['readonly']) == true)
               ||  (($this->columns_edit_mode[$fk_field_name]['readonly']) == "true")))
            {
        ...
        if($this->debug){
            ...
            echo "<table width='".$this->tblWidth[$this->mode]."'><tr><td align='left'><b>search sql (".strtolower($this->lang['total']).": ".$num_rows.") </b>". $sql."</td></tr></table><br />";            
        }       
        ...
        if($mode === "edit"){            
            ...
            if($view_type == "textbox"){ //'view_type"=>"textbox"
                ...
                echo "<input class='class_textbox' type='text' title='".$this->getFieldTitle($fk_field_name)."' id='".$this->getFieldRequiredType($fk_field_name).$fk_field_name."' name='".$this->getFieldRequiredType($fk_field_name).$fk_field_name."' value='".$kFieldValue."' $disabled ".$on_js_event.">";
            }else if($view_type == "radiobutton"){ //'view_type"=>"radiobutton"            
                echo $this->drawRadioButtons($this->getFieldRequiredType($fk_field_name).$fk_field_name, $fk_field_name, $dSet, $kFieldValue, 'field_key', 'field_name', $disabled, $on_js_event);
                ...
                if($req_field_value != "") $kFieldValue = $req_field_value;                            
                echo $this->drawDropDownList($this->getFieldRequiredType($fk_field_name).$fk_field_name, '', $dSet, $kFieldValue, $fk_field_name, 'field_key', 'field_name', $disabled, $on_js_event);
            }
        }else{
            $row = $dSet->fetchRow();
            echo $this->nbsp.$row[$this->foreign_keys_array[$fk_field_name]['field_name']].$this->nbsp;
        }        
    }
    ...
    function setUrlStringFiltering(&$curr_url, $amp=""){
        ...
        if($this->filtering_allowed){
            foreach($this->filter_fields as $fldField){
                ...
                if(isset($_REQUEST[$this->unique_prefix."_ff_".$table_field_name]) AND ($_REQUEST[$this->unique_prefix."_ff_".$table_field_name] != "")){
                    $curr_url .= $amp.$this->unique_prefix."_ff_".$fldField['table'].'_'.$fldField['field']."=".$_REQUEST[$this->unique_prefix."_ff_".$table_field_name]."";
                }
                ...
                if(isset($_REQUEST[$this->unique_prefix."_ff_".$table_field_name_operator]) AND ($_REQUEST[$this->unique_prefix."_ff_".$table_field_name_operator] != "")){
                    $curr_url .= $amp.$this->unique_prefix."_ff_".$fldField['table'].'_'.$fldField['field']."_operator=".$_REQUEST[$this->unique_prefix."_ff_".$table_field_name_operator]."";
                }
            }
            if(isset($_REQUEST[$this->unique_prefix."_ff_".'selSearchType']) && (trim($_REQUEST[$this->unique_prefix."_ff_".'selSearchType']) != ""))
                $curr_url .= $amp.$this->unique_prefix."_ff_"."selSearchType=".$_REQUEST[$this->unique_prefix."_ff_".'selSearchType']."";            
            if(isset($_REQUEST[$this->unique_prefix."_ff_".'selSearchType']) && (trim($_REQUEST[$this->unique_prefix."_ff_".'selSearchType']) != ""))
                $curr_url .= $amp.$this->unique_prefix."_ff_"."selSearchType=".$_REQUEST[$this->unique_prefix."_ff_".'selSearchType']."";
            if($req_onSUBMIT_FILTER != "")
    ...
    function setUrlStringSorting(&$curr_url, $amp=""){
        ...
        if($sort_field != "") {
           ...
           $curr_url .= $amp.$this->unique_prefix."sort_field=".$this->sort_field;
        }else {
    ...
    function getFieldRequiredType($field_name){
        ...
        if(isset($this->columns_edit_mode[$field_name]['req_type'])){
            if(strlen(trim($this->columns_edit_mode[$field_name]['req_type'])) == 3){ $field_prefix = $this->columns_edit_mode[$field_name]['req_type']; }
            else if(strlen(trim($this->columns_edit_mode[$field_name]['req_type'])) == 2){
                $field_prefix = $this->columns_edit_mode[$field_name]['req_type']."y";
            }
        }                
        return $field_prefix;
    }
    ...
    // get Field Property
    //--------------------------------------------------------------------------
    function getFieldProperty($field_name, $property_name, $mode = "edit", $case = "lower"){
        switch($mode){
            case "view":
                if(isset($this->columns_view_mode[$field_name][$property_name])){
                    if($case == "lower") {        
                        return strtolower($this->columns_view_mode[$field_name][$property_name]);
                    } else {
                        return $this->columns_view_mode[$field_name][$property_name];
                    }
                }            
                break;            
            case "edit":
            default:
                if(isset($this->columns_edit_mode[$field_name][$property_name])){            
                    if($case == "lower") {                        
                        return strtolower($this->columns_edit_mode[$field_name][$property_name]);
                    } else {
    ...
    function getFieldTitle($field_name){
        $field_title = isset($this->columns_edit_mode[$field_name]['title']) ? $this->columns_edit_mode[$field_name]['title'] : "";
        if($field_title === ""){
            if(!isset($this->columns_edit_mode[$field_name]['header'])){
                return $field_name;            
            }else{
                return str_replace("'", "&#039;", $this->columns_edit_mode[$field_name]['header']);            
            }            
        }else{
    ...
    function getFieldAlign($ind, $row, $mode="view"){
        ...
        }else if(($mode != "view") && isset($this->columns_edit_mode[$field_name]['align'])){
            return $this->columns_edit_mode[$field_name]['align'];            
        }else{            
    ...
    // draw RadioButtons
    //--------------------------------------------------------------------------
    function drawRadioButtons($tag_name, $field_name, &$select_array, $compare = "", $sub_field_value="", $sub_field_name="", $disabled="", $on_js_event=""){
        $req_print = $this->getVariable('print');
        $text = "";
        if($req_print != true){
            ...
            if(is_object($select_array)){
                while($row = $select_array->fetchRow()){
                    if($row[$this->foreign_keys_array[$field_name][$sub_field_value]] === $compare)                    
                        $text .= "<input class='class_radiobutton' type='radio' title='".$this->getFieldTitle($field_name)."' name='".$tag_name."' id='".$tag_name."' value='".$row[$this->foreign_keys_array[$field_name][$sub_field_value]]."' checked ".$disabled.">".$row[$this->foreign_keys_array[$field_name][$sub_field_name]].$this->nbsp;                    
                    else
                        $text .= "<input class='class_radiobutton' type='radio' title='".$this->getFieldTitle($field_name)."' name='".$tag_name."' id='".$tag_name."' value='".$row[$this->foreign_keys_array[$field_name][$sub_field_value]]."'  ".$disabled.">".$row[$this->foreign_keys_array[$field_name][$sub_field_name]].$this->nbsp;                    
                }                
            }else{
                foreach($select_array as $key => $val){
                    if($key == $compare){
                        $text .= "<input class='class_radiobutton' type='radio' id='".$tag_name."' name='".$tag_name."' value='".$key."' title='".$this->getFieldTitle($field_name)."' checked  ".$disabled.">".$val."&nbsp;";                    
                    }else{
                        $text .= "<input class='class_radiobutton' type='radio' id='".$tag_name."' name='".$tag_name."' value='".$key."' title='".$this->getFieldTitle($field_name)."'  ".$disabled.">".$val."&nbsp;";
                    }
                }                
            }
    ...
    // draw drop-down list
    //--------------------------------------------------------------------------
    function drawDropDownList($tag_name, $foo_name, &$select_array, $compare = "", $field_name="", $sub_field_value="", $sub_field_name="", $disabled="", $on_js_event=""){                       
        $req_print = $this->getVariable('print');
        $text = "";        
        if($req_print != true){
            if(is_object($select_array)){
                $text = "<select class='class_select' name='".$tag_name."' id='".$tag_name."' title='".$this->getFieldTitle($field_name)."' ".(($foo_name != "") ? "onChange='".$this->unique_prefix.$foo_name."'" : "")." ".$disabled." ".$on_js_event.">";
                ...
                $text = "<select class='class_select' name='".$tag_name."' id='".$tag_name."' ".(($foo_name != "") ? "onChange='".$this->unique_prefix.$foo_name."'" : "")." ".$disabled." ".$on_js_event.">";
                foreach($select_array as $key => $val){                    
                    $text .= "<option value='".$key."' ".(($compare == $key) ? "selected" : "").">".$val."</option>";
                }
            }
            $text .= "</select>";
        }else{
            ...
            if($req_print != true){
                switch($mode_type){
                    ...
                    default:
                        ...
                        echo $nbsp."<a class='".$this->unique_prefix."class_a' href='$mode_url' onClick=$onClick title='$alt_name'>".$botton_name."</a>".$nbsp;
                ...
                switch($mode_type){                    
                    ...
                    default:
                        if($div_align){ echo "<div style='float:"; echo ($this->direction == "rtl")?"right":"left"; echo ";'>"; }
                        echo $nbsp."<span class='".$this->unique_prefix."class_a' >".$botton_name."</span>".$nbsp;
                        if($div_align) echo "</div>"; 
                        break;
                }
            }
    ...
    function setCommonJavaScript(){
        echo "\n<!-- This script was generated by datagrid.class.php v.4.2.0 (http://phpbuilder.blogspot.com) -->";

        // set common JavaScript
        if (!file_exists($this->directory.'scripts/dg.js')) {            
            echo "<label class='class_error_message no_print'>Cannot find file: <b>".$this->directory."scripts/dg.js</b>. Check if this file exists and you use a correct path!</label><br /><br />";
        }else{
            echo "\n<script type='text/javascript' src='".$this->directory."scripts/dg.js'></script>";
        }
        // set form checking JavaScript
        if (!file_exists($this->directory.'scripts/form.scripts.js')) {            
            echo "<label class='class_error_message no_print'>Cannot find file: <b>".$this->directory."scripts/form.scripts.js</b>. Check if this file exists and you use a correct path!</label><br /><br />";
        }else{
            echo "\n<script type='text/javascript' src='".$this->directory."scripts/form.scripts.js'></script>";                    
        }
        // include overlib.js file for floating tooltips
        if($this->floating_tool_tips_allowed){
            if (!file_exists($this->directory.'scripts/overlib.js')) {            
                echo "<label class='class_error_message no_print'>Cannot find file: <b>".$this->directory."scripts/overlib.js</b>. Check if this file exists and you use a correct path!</label><br /><br />";
            }else{
                echo "\n<script type='text/javascript' src='".$this->directory."scripts/overlib.js'></script>";                
            }
        }
        // include highlight.js file for rows highlighting
        if($this->row_highlighting_allowed){
            if (!file_exists($this->directory.'scripts/highlight.js')) {            
                echo "<label class='class_error_message no_print'>Cannot find file: <b>".$this->directory."scripts/highlight.js</b>. Check if this file exists and you use a correct path!</label><br /><br />";
            }else{                 
                echo "\n<script type='text/javascript' src='".$this->directory."scripts/highlight.js'></script>";
            }
        }
        // include resizable textarea script, if needed
        if ($this->resizableFildExists()) {            
            if (!file_exists($this->directory.'scripts/resize.js')) {            
                echo "<label class='class_error_message no_print'>Cannot find file: <b>".$this->directory."scripts/resize.js</b>. Check if this file exists and you use a correct path!</label><br /><br />";
            }else{
        ...
        echo "//-->\n";
        echo "</script>";
        echo "\n<script type='text/javascript' src='".$this->directory."wysiwyg/wysiwyg.js'></script>";
    ...
    function setCommonJavaScriptEnd(){
        echo "<script type='text/javascript'>\n";
        echo "<!--\n";
        echo "window.onload = setMaxLength";
        echo "\n//-->\n";
        echo "</script>";        
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    //--------------------------------------------------------------------------
    // check if there is resizable fild
    //--------------------------------------------------------------------------
    function resizableFildExists(){
        foreach($this->columns_edit_mode as $fldName => $fldValue){
    ...
    function setInterfaceLang($lang_name = ""){
        ...
        if (file_exists($this->directory.'languages/'.$this->lang_name.'.php')) {            
            ...
            if (function_exists('setLanguage')){
                ...
                if($this->debug){ echo "<label class='class_error_message no_print'>Your language interface option is turned on, but the system was failed to open correctly stream: <b>'".$this->directory."languages/lang.php'</b>. <br />The structure of the file is corrupted or invalid. Please check it or return the language option to default value: <b>'en'</b>!</label><br />"; }
                $default_language = true;
            }
    	}else{
            if((strtolower($lang_name) != "en") && ($this->debug)){
                echo "<label class='class_error_message no_print'>Your language interface option is turned on, but the system was failed to open stream: <b>'".$this->directory."languages/".$lang_name.".php'</b>. <br />No such file or directory. Please check it or return the language option to default value: <b>'en'</b>!</label><br />";
            }
            $default_language = true;                    
    	}
        ...
        if($default_language){
            ...
            $this->lang['export_message'] = "<label class=\"class_label\">The file _FILE_ is ready. After you finish downloading,</label> <a class=\"class_error_message no_print\" href=\"javascript: window.close();\">close this window</a>.";            
