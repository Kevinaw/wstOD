...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><?php
  ...
  ?><?php
    ...
    { ?><div id="scs_cartmessages_wrapper"><div id="scs_cartmessages"><div id="scs_cartmessages_content"><?php echo $myPage->getCartMessage(); ?></div></div></div><?php } else { ?><div id="scs_cartmessages_wrapper"><div id="scs_cartmessages" style="display:none"><div id="scs_cartmessages_content">&#160;</div></div></div><?php } ?><div id="scs_staticcontent_home"><div id="scs_staticcontent_wrapper"><div id="scs_staticcontent"><div id="scs_staticcontent_content"><?php
    
    if ( 
    $currentpage_content ) 
    { ?><?php
        echo $currentpage_content;
      ?><?php } else { ?><span class="scs_sdkworkaround">&#160;</span><?php } ?></div></div></div></div><div class="scs_productlist"><?php
    
    if ( 
    $myPage->getConfig('showhomeonlyproducts') ) 
    { ?><!-- Product list without showing category names --><!-- Loops only through the products with a star--><?php
    ...
    $starredgroup_productscount = strval( count( $starredgroup_products ) );
    $starredgroup_iteration = 0;
    
    $starredgroup_parentid = $starredgroup['parentid'];
    $starredgroup_parentname = $starredgroup['parentname'];
    $starredgroup_parenthref = $starredgroup['parenthref'];
    $starredgroup_image = $starredgroup['image'];
    $starredgroup_imageisset = $starredgroup['imageisset'];
    $starredgroup_tileimage = $starredgroup['tileimage'];
    $starredgroup_image = $starredgroup['image'];
    $starredgroup_content = $starredgroup['content'];

    $starredgroup_subgroupsids = $starredgroup['subgroupsIds'];
    $starredgroup_subgroupscount =  strval( count( $starredgroup_subgroupsids ) );
  ...
  ?><?php
    ...
    { ?><p class="scs_price"><?php  echo $myPage->getConfig('currencysymbol'); ?><?php
        echo $product_yourprice;
      ?></p><?php } else { ?><p class="scs_price_discounted"><?php  echo $myPage->getConfig('currencysymbol'); ?><?php
        echo $product_yourprice;
      ?></p><p class="scs_price_list"><?php  echo $myPage->getConfig('currencysymbol'); ?><?php
        echo $product_price;
      ?></p><?php } ?></div><?php } ?><?php
    ...
    { ?><br /><span class="scs_product_shortdescription"><?php
      ...
      ?></span><?php } ?></p></div></div><?php } ?><?php } ?><?php } else { ?><!-- Product list showing category names --><!-- Loop only the groups with star products. The groups have the same properties as a normal group --><!-- Subgroups are already sorted after their parent group --><?php
  ...
  ?><?php
    ...
    if ( 
    $starredgroup_parentid =='-1' ) 
    { ?><?php
    
    if ( 
    $myPage->getConfig('showhomecategorydetails') ) 
    ...
    foreach($myPage->getSubGroups($starredgroup_id) as  
          $subgrp )
    {
    ?><?php
        $subgrp_id = $subgrp['groupid'];
  ...
  ?><div class="scs_subcategory_tiles_item"><div class="scs_subcategory_tiles_item_title"><?php
    ...
    if ( 
    $myPage->getConfig('showhomeproducts') ) 
    { ?><?php
    ...
    { ?><div class="scs_category_section_header_wrapper"><div class="scs_category_section_header"><div class="scs_categorieslist_item_sublevel"><div class="scs_categorieslist_link_sublevel_wrapper"><div class="scs_categorieslist_link_sublevel"><a class="scs_categorieslist_link" href="<?php
      ...
      ?>">Products in <?php
        echo $starredgroup_name;
      ?></a></div></div></div></div></div><?php } ?><div class="scs_category_items_wrapper"><!-- Loops only through the products with a star--><?php
    ...
    { ?><div class="scs_viewdetails_wrapper"><form action="<?php
      ...
      ?>" /><input type="hidden" name="groupid" value="<?php
        echo $product_groupid;
      ?>" /><input type="submit" value="View Details" class="scs_addtocart"/></p></form></div><?php } else { ?><div class="scs_addtocart_wrapper"><form action="<?php echo $myPage->getUrl(); ?>" method="post" class="buylink"><p><input type="hidden" name="method" value="add" /><input type="hidden" name="productid" value="<?php
        echo $product_id;
      ?>" /><input type="hidden" name="groupid" value="<?php
        echo $product_groupid;
      ?>" /><input type="submit" value="Add to Cart" class="scs_addtocart" /></p></form></div><?php } ?><?php } else { ?><div class="scs_stocksold_wrapper"><div class="scs_stocksold"><span class="scs_sdkworkaround">&#160;</span></div></div><?php } ?><?php } else { ?><?php
  ...
  ?><?php
    ...
    { ?><br /><span class="scs_product_shortdescription"><?php
      ...
      ?></span><?php } ?></p></div></div><?php } ?><?php } ?><?php } ?><?php } ?></div>	<!-- scs_category_items_wrapper --><?php } ?><?php } ?><?php } ?><?php } ?><span class="scs_sdkworkaround">&#160;</span></div></div></div></div></div></div></div><div class="scs_cleardiv"><span class="scs_sdkworkaround">&#160;</span></div></div></div></div><div id="scs_footer_area_wrapper"><div id="scs_footer_area_inner_wrapper"><div id="scs_footer_area"><div id="scs_footer_wrapper"><div id="scs_footer_inner_wrapper"><div id="scs_footer"><div class="scs_flat_navmenu"><?php
