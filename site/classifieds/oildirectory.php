 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'service@oildirectory.com');
   /**
    * The default CC address.
    */   
   define('CC_FB_CC_EMAIL', 'maps@oildirectory.com'); 
   /**
    ...
    */  
   define('CC_FB_AUTO_REPLY_SUBJECT', 'Thank You for your business');   
   /**
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://www.oildirectory.com/thankyou');
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_AUTO_REPLY)
         {
            $form_user_msg = parseMessage('Thank you for signing up on Save On Staff Recruiting. You have listed your company name under the following categories:[Category 1],[Category 2],[Category 3],[Category 4],[Category 5],[Category 6].

I will contact you within the next 2 days to set everything up.

Yours Truly
Jarrett (Jerry) Huebner
780-249-9722
', $preferences);
