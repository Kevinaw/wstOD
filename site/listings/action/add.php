...
ob_start();
  ...
  function save_listing(){
      ...
      if(!validEmail($_POST["listing"]["new"]["info"]["update_email"])) $errors[]="You must enter a valid administrator email address, this will be used to confirm changes to the listing but will not be displayed in the listing";
